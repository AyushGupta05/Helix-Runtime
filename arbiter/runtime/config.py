...
class RuntimeConfig(BaseSettings):
    ...
    anthropic_model_triage: str = Field(default="claude-3-5-haiku-latest", alias="ANTHROPIC_MODEL_TRIAGE")
    anthropic_model_bid_fast: str = Field(default="claude-3-5-haiku-latest", alias="ANTHROPIC_MODEL_BID_FAST")
